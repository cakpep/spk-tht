    ...
    <section class="sidebar">
        ...
        Nav::widget(
            [
                ...
                'items' => [
                    [
                        'label' => '<span class="fa fa-angle-down"></span><span class="text-info">App Settings</span>',
                        'url' => '#'
                    ],
                    ['label' => '<span class="fa fa-file-code-o"></span>Frontend', 'url' => '/advanced'],
                    ['label' => '<span class="fa fa-file-code-o"></span> User Akses', 'url' => ['/admin']],
                    ...
                    ['label' => '<span class="fa fa-file-code-o"></span> Gii', 'url' => ['/gii']],
                    ['label' => '<span class="fa fa-dashboard"></span> Debug', 'url' => ['/debug']],
                    ['label' => '<span class="fa fa-dashboard"></span> Kecamatan', 'url' => ['/kecamatan']],
