            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-4 text-center" >
                    <div class="row" style="padding-left:70px">
                        <?php 
                            $gbr=!empty($model->foto) ? Url::to('@web').'/../uploads/foto_profil/'.$model->foto : Url::to('@web').'/../uploads/foto_profil/images.png';                       
                            echo  '<img src='.$gbr.' alt="" class="img-circle img-responsive" />';
                        ?>
                    </div>                    
                </div>
                <div class="col-sm-8" >
