...
$this->title = 'Data Skala Ketidakpastian';
...
<div class="diagnosa-uncertanty-term-index">
...
<?php Pjax::begin(['id' => 'diagnosa-uncertanty-term-gridview']) ?> 
    <?= GridView::widget([
        'id'=>'diagnosa-uncertanty-term-table-grid',
