...
<div class="user-form">
    ...
    <!-- ?=
            $form->field($auth, 'item_name')->dropDownList(
                                            \common\models\AuthAssignment::authItem(),
                                            ['prompt'=>'Select...'])->label('Pilih Level')
        ?>  
 -->
 <?=
            $form->field($model, 'status')->dropDownList(
                                            array(0=>'Tidak Aktif',10=>'Aktif'),
                                            ['prompt'=>'Select...'])->label('Pilih Status')
        ?>  
