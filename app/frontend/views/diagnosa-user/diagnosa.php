		...
		<div class="list-group">
		  <a href="#" class="list-group-item">
		    ...
		    <p class="list-group-item-text">
		    	<ul>
		    		<li>Untuk memulai dignosa penyakit anda, pastikan Gejala-gejala yang timbul pada anda.</li>
		    		<li>Kemudian pilihlah/centanglah gejala-gejala sesuai dengan yang anda rasakan pada form daftar gejala di bawah ini.</li>
